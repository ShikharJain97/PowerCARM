...
"vmovapd %%ymm11, 320(%%r11)\n\t"\
"vmovapd %%ymm12, 352(%%r11)\n\t"\
"vmovapd %%ymm13, 384(%%r11)\n\t"\
"vmovapd %%ymm14, 416(%%r11)\n\t"\
"vfmadd132pd %%ymm15, %%ymm15, %%ymm15\n\t"\
"vmovapd %%ymm0, 448(%%r11)\n\t"\
"vmovapd %%ymm1, 480(%%r11)\n\t"\
"vmovapd %%ymm2, 512(%%r11)\n\t"\
"vmovapd %%ymm3, 544(%%r11)\n\t"\
"vmovapd %%ymm4, 576(%%r11)\n\t"\
"vmovapd %%ymm5, 608(%%r11)\n\t"\
"vmovapd %%ymm6, 640(%%r11)\n\t"\
"vfmadd132pd %%ymm7, %%ymm7, %%ymm7\n\t"\
"vmovapd %%ymm8, 672(%%r11)\n\t"\
"vmovapd %%ymm9, 704(%%r11)\n\t"\
"vmovapd %%ymm10, 736(%%r11)\n\t"\
"vmovapd %%ymm11, 768(%%r11)\n\t"\
"vmovapd %%ymm12, 800(%%r11)\n\t"\
"vmovapd %%ymm13, 832(%%r11)\n\t"\
"vmovapd %%ymm14, 864(%%r11)\n\t"\
"vfmadd132pd %%ymm15, %%ymm15, %%ymm15\n\t"\
"add $896, %%r11\n\t"\
"sub $896, %%r12\n\t"\
...
roofline_output_end_measure(out, repeat*data->size, repeat*data->size*32/896, repeat*data->size*32/896);
