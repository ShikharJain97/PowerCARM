...
__asm__ __volatile__ (\
"loop_LOAD_NT_MAD_repeat:\n\t"\
"mov %1, %%r11\n\t"\
"mov %2, %%r12\n\t"\
"buffer_LOAD_NT_MAD_increment:\n\t"\
"vmovapd 0(%%r11), %%ymm0\n\t"\
"vmovapd 32(%%r11), %%ymm1\n\t"\
"vmovapd 64(%%r11), %%ymm2\n\t"\
"vmovapd 96(%%r11), %%ymm3\n\t"\
...
"vmovapd 480(%%r11), %%ymm3\n\t"\
"vmovapd 512(%%r11), %%ymm4\n\t"\
"vmovapd 544(%%r11), %%ymm5\n\t"\
"vmovapd 576(%%r11), %%ymm6\n\t"\
"vmovapd 608(%%r11), %%ymm7\n\t"\
"vmovapd 640(%%r11), %%ymm8\n\t"\
"vmovapd 672(%%r11), %%ymm9\n\t"\
"vmovapd 704(%%r11), %%ymm10\n\t"\
"vmovapd 736(%%r11), %%ymm11\n\t"\
"vmovapd 768(%%r11), %%ymm12\n\t"\
"vmovapd 800(%%r11), %%ymm13\n\t"\
"vaddpd %%ymm14, %%ymm14, %%ymm14\n\t"\
"vmulpd %%ymm15, %%ymm15, %%ymm15\n\t"\
"vaddpd %%ymm0, %%ymm0, %%ymm0\n\t"\
"vmulpd %%ymm1, %%ymm1, %%ymm1\n\t"\
"vmovapd 832(%%r11), %%ymm2\n\t"\
"vmovapd 864(%%r11), %%ymm3\n\t"\
"vmovapd 896(%%r11), %%ymm4\n\t"\
"vmovapd 928(%%r11), %%ymm5\n\t"\
"vmovapd 960(%%r11), %%ymm6\n\t"\
"vmovapd 992(%%r11), %%ymm7\n\t"\
"vmovapd 1024(%%r11), %%ymm8\n\t"\
"vmovapd 1056(%%r11), %%ymm9\n\t"\
"vmovapd 1088(%%r11), %%ymm10\n\t"\
"vmovapd 1120(%%r11), %%ymm11\n\t"\
"vmovapd 1152(%%r11), %%ymm12\n\t"\
"vmovapd 1184(%%r11), %%ymm13\n\t"\
"vmovapd 1216(%%r11), %%ymm14\n\t"\
"vaddpd %%ymm15, %%ymm15, %%ymm15\n\t"\
"vmulpd %%ymm0, %%ymm0, %%ymm0\n\t"\
"vaddpd %%ymm1, %%ymm1, %%ymm1\n\t"\
"vmulpd %%ymm2, %%ymm2, %%ymm2\n\t"\
"vmovapd 1248(%%r11), %%ymm3\n\t"\
"vmovapd 1280(%%r11), %%ymm4\n\t"\
"vmovapd 1312(%%r11), %%ymm5\n\t"\
"vmovapd 1344(%%r11), %%ymm6\n\t"\
"vmovapd 1376(%%r11), %%ymm7\n\t"\
"vmovapd 1408(%%r11), %%ymm8\n\t"\
"vmovapd 1440(%%r11), %%ymm9\n\t"\
"vmovapd 1472(%%r11), %%ymm10\n\t"\
"vmovapd 1504(%%r11), %%ymm11\n\t"\
"vmovapd 1536(%%r11), %%ymm12\n\t"\
"vmovapd 1568(%%r11), %%ymm13\n\t"\
"vmovapd 1600(%%r11), %%ymm14\n\t"\
"vmovapd 1632(%%r11), %%ymm15\n\t"\
"vaddpd %%ymm0, %%ymm0, %%ymm0\n\t"\
"vmulpd %%ymm1, %%ymm1, %%ymm1\n\t"\
...
"vmovapd 1728(%%r11), %%ymm6\n\t"\
"vmovapd 1760(%%r11), %%ymm7\n\t"\
"vmovapd 1792(%%r11), %%ymm8\n\t"\
"vmovapd 1824(%%r11), %%ymm9\n\t"\
"vmovapd 1856(%%r11), %%ymm10\n\t"\
"vmovapd 1888(%%r11), %%ymm11\n\t"\
"vmovapd 1920(%%r11), %%ymm12\n\t"\
"vmovapd 1952(%%r11), %%ymm13\n\t"\
"vmovapd 1984(%%r11), %%ymm14\n\t"\
"vmovapd 2016(%%r11), %%ymm15\n\t"\
"vmovapd 2048(%%r11), %%ymm0\n\t"\
"vaddpd %%ymm1, %%ymm1, %%ymm1\n\t"\
"vmulpd %%ymm2, %%ymm2, %%ymm2\n\t"\
...
"add $2080, %%r11\n\t"\
"sub $2080, %%r12\n\t"\
"jnz buffer_LOAD_NT_MAD_increment\n\t"\
"sub $1, %0\n\t"\
"jnz loop_LOAD_NT_MAD_repeat\n\t"\
...
roofline_output_end_measure(out, repeat*data->size, repeat*data->size*80/2080, repeat*data->size*85/2080);
...
roofline_output_begin_measure(out);
__asm__ __volatile__ (\
"loop_LOAD_NT_MAD_validation_repeat:\n\t"\
"mov %1, %%r11\n\t"\
"mov %2, %%r12\n\t"\
"buffer_LOAD_NT_MAD_validation_increment:\n\t"\
"add $2080, %%r11\n\t"\
"sub $2080, %%r12\n\t"\
"jnz buffer_LOAD_NT_MAD_validation_increment\n\t"\
"sub $1, %0\n\t"\
"jnz loop_LOAD_NT_MAD_validation_repeat\n\t"\
