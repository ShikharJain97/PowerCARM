...
"vmovapd 512(%%r11), %%ymm5\n\t"\
"vmovapd 544(%%r11), %%ymm6\n\t"\
"vmulpd %%ymm7, %%ymm7, %%ymm7\n\t"\
"vmovapd %%ymm8, 576(%%r11)\n\t"\
"vmovapd 608(%%r11), %%ymm9\n\t"\
"vmovapd 640(%%r11), %%ymm10\n\t"\
"vaddpd %%ymm11, %%ymm11, %%ymm11\n\t"\
"vmovapd %%ymm12, 672(%%r11)\n\t"\
"vmovapd 704(%%r11), %%ymm13\n\t"\
...
roofline_output_end_measure(out, repeat*data->size, repeat*data->size*32/768, repeat*data->size*32/768);
