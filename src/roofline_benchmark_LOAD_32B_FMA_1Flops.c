...
__asm__ __volatile__ (\
"loop_LOAD_FMA_repeat:\n\t"\
"mov %1, %%r11\n\t"\
"mov %2, %%r12\n\t"\
"buffer_LOAD_FMA_increment:\n\t"\
"vmovapd 0(%%r11), %%ymm0\n\t"\
"vmovapd 32(%%r11), %%ymm1\n\t"\
"vmovapd 64(%%r11), %%ymm2\n\t"\
"vmovapd 96(%%r11), %%ymm3\n\t"\
...
"add $2048, %%r11\n\t"\
"sub $2048, %%r12\n\t"\
"jnz buffer_LOAD_FMA_increment\n\t"\
"sub $1, %0\n\t"\
"jnz loop_LOAD_FMA_repeat\n\t"\
...
roofline_output_begin_measure(out);
__asm__ __volatile__ (\
"loop_LOAD_FMA_validation_repeat:\n\t"\
"mov %1, %%r11\n\t"\
"mov %2, %%r12\n\t"\
"buffer_LOAD_FMA_validation_increment:\n\t"\
"add $2048, %%r11\n\t"\
"sub $2048, %%r12\n\t"\
"jnz buffer_LOAD_FMA_validation_increment\n\t"\
"sub $1, %0\n\t"\
"jnz loop_LOAD_FMA_validation_repeat\n\t"\
