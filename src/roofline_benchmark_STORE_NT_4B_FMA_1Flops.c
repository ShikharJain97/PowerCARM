...
"vmovntpd %%ymm2, 32(%%r11)\n\t"\
"vfmadd132pd %%ymm3, %%ymm3, %%ymm3\n\t"\
"vmovntpd %%ymm4, 64(%%r11)\n\t"\
"vfmadd132pd %%ymm5, %%ymm5, %%ymm5\n\t"\
"vmovntpd %%ymm6, 96(%%r11)\n\t"\
"vfmadd132pd %%ymm7, %%ymm7, %%ymm7\n\t"\
"vmovntpd %%ymm8, 128(%%r11)\n\t"\
"vfmadd132pd %%ymm9, %%ymm9, %%ymm9\n\t"\
"vmovntpd %%ymm10, 160(%%r11)\n\t"\
"vfmadd132pd %%ymm11, %%ymm11, %%ymm11\n\t"\
"vmovntpd %%ymm12, 192(%%r11)\n\t"\
"vfmadd132pd %%ymm13, %%ymm13, %%ymm13\n\t"\
"vmovntpd %%ymm14, 224(%%r11)\n\t"\
"vfmadd132pd %%ymm15, %%ymm15, %%ymm15\n\t"\
"vmovntpd %%ymm0, 256(%%r11)\n\t"\
"vfmadd132pd %%ymm1, %%ymm1, %%ymm1\n\t"\
"vmovntpd %%ymm2, 288(%%r11)\n\t"\
"vfmadd132pd %%ymm3, %%ymm3, %%ymm3\n\t"\
"vmovntpd %%ymm4, 320(%%r11)\n\t"\
"vfmadd132pd %%ymm5, %%ymm5, %%ymm5\n\t"\
"vmovntpd %%ymm6, 352(%%r11)\n\t"\
"vfmadd132pd %%ymm7, %%ymm7, %%ymm7\n\t"\
"vmovntpd %%ymm8, 384(%%r11)\n\t"\
"vfmadd132pd %%ymm9, %%ymm9, %%ymm9\n\t"\
"vmovntpd %%ymm10, 416(%%r11)\n\t"\
"vfmadd132pd %%ymm11, %%ymm11, %%ymm11\n\t"\
"vmovntpd %%ymm12, 448(%%r11)\n\t"\
"vfmadd132pd %%ymm13, %%ymm13, %%ymm13\n\t"\
"vmovntpd %%ymm14, 480(%%r11)\n\t"\
"vfmadd132pd %%ymm15, %%ymm15, %%ymm15\n\t"\
"add $512, %%r11\n\t"\
"sub $512, %%r12\n\t"\
