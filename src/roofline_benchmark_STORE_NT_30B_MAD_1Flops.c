...
"vmovntpd %%ymm11, 352(%%r11)\n\t"\
"vmovntpd %%ymm12, 384(%%r11)\n\t"\
"vmovntpd %%ymm13, 416(%%r11)\n\t"\
"vmovntpd %%ymm14, 448(%%r11)\n\t"\
...
"vmovntpd %%ymm8, 640(%%r11)\n\t"\
"vmovntpd %%ymm9, 672(%%r11)\n\t"\
...
"vmovntpd %%ymm6, 960(%%r11)\n\t"\
"vmovntpd %%ymm7, 992(%%r11)\n\t"\
"vmovntpd %%ymm8, 1024(%%r11)\n\t"\
"vmovntpd %%ymm9, 1056(%%r11)\n\t"\
"vmovntpd %%ymm10, 1088(%%r11)\n\t"\
"vmovntpd %%ymm11, 1120(%%r11)\n\t"\
"vmovntpd %%ymm12, 1152(%%r11)\n\t"\
"vmovntpd %%ymm13, 1184(%%r11)\n\t"\
"vmovntpd %%ymm14, 1216(%%r11)\n\t"\
"vmovntpd %%ymm15, 1248(%%r11)\n\t"\
"vmovntpd %%ymm0, 1280(%%r11)\n\t"\
"vmovntpd %%ymm1, 1312(%%r11)\n\t"\
"vmovntpd %%ymm2, 1344(%%r11)\n\t"\
"vmovntpd %%ymm3, 1376(%%r11)\n\t"\
"vmovntpd %%ymm4, 1408(%%r11)\n\t"\
"vaddpd %%ymm5, %%ymm5, %%ymm5\n\t"\
"vmulpd %%ymm6, %%ymm6, %%ymm6\n\t"\
"vaddpd %%ymm7, %%ymm7, %%ymm7\n\t"\
"vmulpd %%ymm8, %%ymm8, %%ymm8\n\t"\
"vmovntpd %%ymm9, 1440(%%r11)\n\t"\
"vmovntpd %%ymm10, 1472(%%r11)\n\t"\
"vmovntpd %%ymm11, 1504(%%r11)\n\t"\
"vmovntpd %%ymm12, 1536(%%r11)\n\t"\
"vmovntpd %%ymm13, 1568(%%r11)\n\t"\
"vmovntpd %%ymm14, 1600(%%r11)\n\t"\
"vmovntpd %%ymm15, 1632(%%r11)\n\t"\
"vmovntpd %%ymm0, 1664(%%r11)\n\t"\
"vmovntpd %%ymm1, 1696(%%r11)\n\t"\
"vmovntpd %%ymm2, 1728(%%r11)\n\t"\
"vmovntpd %%ymm3, 1760(%%r11)\n\t"\
"vmovntpd %%ymm4, 1792(%%r11)\n\t"\
"vmovntpd %%ymm5, 1824(%%r11)\n\t"\
"vmovntpd %%ymm6, 1856(%%r11)\n\t"\
"vmovntpd %%ymm7, 1888(%%r11)\n\t"\
