...
"vmovntpd %%ymm12, 288(%%r11)\n\t"\
"vmovntpd %%ymm13, 320(%%r11)\n\t"\
"vmovntpd %%ymm14, 352(%%r11)\n\t"\
"vfmadd132pd %%ymm15, %%ymm15, %%ymm15\n\t"\
"vmovntpd %%ymm0, 384(%%r11)\n\t"\
"vmovntpd %%ymm1, 416(%%r11)\n\t"\
"vmovntpd %%ymm2, 448(%%r11)\n\t"\
"vfmadd132pd %%ymm3, %%ymm3, %%ymm3\n\t"\
"vmovntpd %%ymm4, 480(%%r11)\n\t"\
"vmovntpd %%ymm5, 512(%%r11)\n\t"\
"vmovntpd %%ymm6, 544(%%r11)\n\t"\
"vfmadd132pd %%ymm7, %%ymm7, %%ymm7\n\t"\
"vmovntpd %%ymm8, 576(%%r11)\n\t"\
"vmovntpd %%ymm9, 608(%%r11)\n\t"\
"vmovntpd %%ymm10, 640(%%r11)\n\t"\
"vfmadd132pd %%ymm11, %%ymm11, %%ymm11\n\t"\
"vmovntpd %%ymm12, 672(%%r11)\n\t"\
"vmovntpd %%ymm13, 704(%%r11)\n\t"\
"vmovntpd %%ymm14, 736(%%r11)\n\t"\
"vfmadd132pd %%ymm15, %%ymm15, %%ymm15\n\t"\
"add $768, %%r11\n\t"\
"sub $768, %%r12\n\t"\
