...
"vmovapd 896(%%r11), %%ymm2\n\t"\
"vmovapd 928(%%r11), %%ymm3\n\t"\
"vmovapd %%ymm4, 960(%%r11)\n\t"\
"vmovapd 992(%%r11), %%ymm5\n\t"\
"vmovapd 1024(%%r11), %%ymm6\n\t"\
"vmovapd %%ymm7, 1056(%%r11)\n\t"\
"vmovapd 1088(%%r11), %%ymm8\n\t"\
"vmovapd 1120(%%r11), %%ymm9\n\t"\
"vfmadd132pd %%ymm10, %%ymm10, %%ymm10\n\t"\
"vfmadd132pd %%ymm11, %%ymm11, %%ymm11\n\t"\
"vmovapd %%ymm12, 1152(%%r11)\n\t"\
"vmovapd 1184(%%r11), %%ymm13\n\t"\
"vmovapd 1216(%%r11), %%ymm14\n\t"\
"vmovapd %%ymm15, 1248(%%r11)\n\t"\
"vmovapd 1280(%%r11), %%ymm0\n\t"\
"vmovapd 1312(%%r11), %%ymm1\n\t"\
"vmovapd %%ymm2, 1344(%%r11)\n\t"\
"vmovapd 1376(%%r11), %%ymm3\n\t"\
"vmovapd 1408(%%r11), %%ymm4\n\t"\
"vfmadd132pd %%ymm5, %%ymm5, %%ymm5\n\t"\
"vfmadd132pd %%ymm6, %%ymm6, %%ymm6\n\t"\
"vmovapd %%ymm7, 1440(%%r11)\n\t"\
"vmovapd 1472(%%r11), %%ymm8\n\t"\
"vmovapd 1504(%%r11), %%ymm9\n\t"\
"vmovapd %%ymm10, 1536(%%r11)\n\t"\
"vmovapd 1568(%%r11), %%ymm11\n\t"\
"vmovapd 1600(%%r11), %%ymm12\n\t"\
"vmovapd %%ymm13, 1632(%%r11)\n\t"\
"vmovapd 1664(%%r11), %%ymm14\n\t"\
"vmovapd 1696(%%r11), %%ymm15\n\t"\
"vfmadd132pd %%ymm0, %%ymm0, %%ymm0\n\t"\
"vfmadd132pd %%ymm1, %%ymm1, %%ymm1\n\t"\
"vmovapd %%ymm2, 1728(%%r11)\n\t"\
"vmovapd 1760(%%r11), %%ymm3\n\t"\
"vmovapd 1792(%%r11), %%ymm4\n\t"\
"vmovapd %%ymm5, 1824(%%r11)\n\t"\
"vmovapd 1856(%%r11), %%ymm6\n\t"\
"vmovapd 1888(%%r11), %%ymm7\n\t"\
"vmovapd %%ymm8, 1920(%%r11)\n\t"\
"vmovapd 1952(%%r11), %%ymm9\n\t"\
"vmovapd 1984(%%r11), %%ymm10\n\t"\
"vfmadd132pd %%ymm11, %%ymm11, %%ymm11\n\t"\
...
roofline_output_end_measure(out, repeat*data->size, repeat*data->size*112/2016, repeat*data->size*77/2016);
