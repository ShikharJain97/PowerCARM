...
"vmovapd 256(%%r11), %%ymm9\n\t"\
"vmovapd 288(%%r11), %%ymm10\n\t"\
"vmovapd 320(%%r11), %%ymm11\n\t"\
"vmovapd 352(%%r11), %%ymm12\n\t"\
"vmovapd 384(%%r11), %%ymm13\n\t"\
"vmovapd 416(%%r11), %%ymm14\n\t"\
"vmovapd 448(%%r11), %%ymm15\n\t"\
"vmovapd 480(%%r11), %%ymm0\n\t"\
...
"vmovapd 768(%%r11), %%ymm11\n\t"\
"vmovapd 800(%%r11), %%ymm12\n\t"\
"vmovapd 832(%%r11), %%ymm13\n\t"\
"vmovapd 864(%%r11), %%ymm14\n\t"\
"vmovapd 896(%%r11), %%ymm15\n\t"\
"vmovapd 928(%%r11), %%ymm0\n\t"\
"vmovapd 960(%%r11), %%ymm1\n\t"\
"vmovapd 992(%%r11), %%ymm2\n\t"\
...
"vmovapd 1248(%%r11), %%ymm11\n\t"\
"vfmadd132pd %%ymm12, %%ymm12, %%ymm12\n\t"\
"vmovapd 1280(%%r11), %%ymm13\n\t"\
"vmovapd 1312(%%r11), %%ymm14\n\t"\
"vmovapd 1344(%%r11), %%ymm15\n\t"\
"vmovapd 1376(%%r11), %%ymm0\n\t"\
"vmovapd 1408(%%r11), %%ymm1\n\t"\
"vmovapd 1440(%%r11), %%ymm2\n\t"\
"vmovapd 1472(%%r11), %%ymm3\n\t"\
"vmovapd 1504(%%r11), %%ymm4\n\t"\
"vfmadd132pd %%ymm5, %%ymm5, %%ymm5\n\t"\
"vmovapd 1536(%%r11), %%ymm6\n\t"\
"vmovapd 1568(%%r11), %%ymm7\n\t"\
"vmovapd 1600(%%r11), %%ymm8\n\t"\
"vmovapd 1632(%%r11), %%ymm9\n\t"\
"vmovapd 1664(%%r11), %%ymm10\n\t"\
"vmovapd 1696(%%r11), %%ymm11\n\t"\
"vmovapd 1728(%%r11), %%ymm12\n\t"\
"vmovapd 1760(%%r11), %%ymm13\n\t"\
"vfmadd132pd %%ymm14, %%ymm14, %%ymm14\n\t"\
"vmovapd 1792(%%r11), %%ymm15\n\t"\
"vmovapd 1824(%%r11), %%ymm0\n\t"\
"vmovapd 1856(%%r11), %%ymm1\n\t"\
"vmovapd 1888(%%r11), %%ymm2\n\t"\
"vmovapd 1920(%%r11), %%ymm3\n\t"\
"vmovapd 1952(%%r11), %%ymm4\n\t"\
"vmovapd 1984(%%r11), %%ymm5\n\t"\
"vmovapd 2016(%%r11), %%ymm6\n\t"\
...
roofline_output_end_measure(out, repeat*data->size, repeat*data->size*64/2048, repeat*data->size*72/2048);
