...
"vmovntpd %%ymm8, 192(%%r11)\n\t"\
"vmovntpd %%ymm9, 224(%%r11)\n\t"\
...
"vmovntpd %%ymm5, 480(%%r11)\n\t"\
"vmovntpd %%ymm6, 512(%%r11)\n\t"\
"vmovntpd %%ymm7, 544(%%r11)\n\t"\
"vmovntpd %%ymm8, 576(%%r11)\n\t"\
"vmovntpd %%ymm9, 608(%%r11)\n\t"\
...
"vmovntpd %%ymm3, 800(%%r11)\n\t"\
"vmovntpd %%ymm4, 832(%%r11)\n\t"\
"vmovntpd %%ymm5, 864(%%r11)\n\t"\
"vmovntpd %%ymm6, 896(%%r11)\n\t"\
"vmovntpd %%ymm7, 928(%%r11)\n\t"\
...
"vmovntpd %%ymm1, 1120(%%r11)\n\t"\
"vmovntpd %%ymm2, 1152(%%r11)\n\t"\
"vmovntpd %%ymm3, 1184(%%r11)\n\t"\
"vmovntpd %%ymm4, 1216(%%r11)\n\t"\
"vmovntpd %%ymm5, 1248(%%r11)\n\t"\
"vfmadd132pd %%ymm6, %%ymm6, %%ymm6\n\t"\
...
"vmovntpd %%ymm15, 1440(%%r11)\n\t"\
"vmovntpd %%ymm0, 1472(%%r11)\n\t"\
"vmovntpd %%ymm1, 1504(%%r11)\n\t"\
"vmovntpd %%ymm2, 1536(%%r11)\n\t"\
"vmovntpd %%ymm3, 1568(%%r11)\n\t"\
"vfmadd132pd %%ymm4, %%ymm4, %%ymm4\n\t"\
"vfmadd132pd %%ymm5, %%ymm5, %%ymm5\n\t"\
