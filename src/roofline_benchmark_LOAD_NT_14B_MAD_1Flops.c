...
"vmovapd 1440(%%r11), %%ymm5\n\t"\
"vmovapd 1472(%%r11), %%ymm6\n\t"\
"vmovapd 1504(%%r11), %%ymm7\n\t"\
"vmovapd 1536(%%r11), %%ymm8\n\t"\
"vaddpd %%ymm9, %%ymm9, %%ymm9\n\t"\
"vmulpd %%ymm10, %%ymm10, %%ymm10\n\t"\
...
roofline_output_end_measure(out, repeat*data->size, repeat*data->size*112/1568, repeat*data->size*77/1568);
