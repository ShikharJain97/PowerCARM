...
"vmovapd %%ymm7, 96(%%r11)\n\t"\
"vmovapd %%ymm8, 128(%%r11)\n\t"\
"vmovapd %%ymm9, 160(%%r11)\n\t"\
"vaddpd %%ymm10, %%ymm10, %%ymm10\n\t"\
"vmulpd %%ymm11, %%ymm11, %%ymm11\n\t"\
"vaddpd %%ymm12, %%ymm12, %%ymm12\n\t"\
"vmulpd %%ymm13, %%ymm13, %%ymm13\n\t"\
"vmovapd %%ymm14, 192(%%r11)\n\t"\
"vmovapd %%ymm15, 224(%%r11)\n\t"\
"vmovapd %%ymm0, 256(%%r11)\n\t"\
"vaddpd %%ymm1, %%ymm1, %%ymm1\n\t"\
"vmulpd %%ymm2, %%ymm2, %%ymm2\n\t"\
"vaddpd %%ymm3, %%ymm3, %%ymm3\n\t"\
"vmulpd %%ymm4, %%ymm4, %%ymm4\n\t"\
"vmovapd %%ymm5, 288(%%r11)\n\t"\
"vmovapd %%ymm6, 320(%%r11)\n\t"\
"vmovapd %%ymm7, 352(%%r11)\n\t"\
"vaddpd %%ymm8, %%ymm8, %%ymm8\n\t"\
"vmulpd %%ymm9, %%ymm9, %%ymm9\n\t"\
"vaddpd %%ymm10, %%ymm10, %%ymm10\n\t"\
"vmulpd %%ymm11, %%ymm11, %%ymm11\n\t"\
"vmovapd %%ymm12, 384(%%r11)\n\t"\
"vmovapd %%ymm13, 416(%%r11)\n\t"\
"vmovapd %%ymm14, 448(%%r11)\n\t"\
...
"vmovapd %%ymm0, 896(%%r11)\n\t"\
"vmovapd %%ymm1, 928(%%r11)\n\t"\
