...
__asm__ __volatile__ (\
"loop_STORE_FMA_repeat:\n\t"\
"mov %1, %%r11\n\t"\
"mov %2, %%r12\n\t"\
"buffer_STORE_FMA_increment:\n\t"\
"vmovapd %%ymm0, 0(%%r11)\n\t"\
"vmovapd %%ymm1, 32(%%r11)\n\t"\
"vmovapd %%ymm2, 64(%%r11)\n\t"\
"vmovapd %%ymm3, 96(%%r11)\n\t"\
"vfmadd132pd %%ymm4, %%ymm4, %%ymm4\n\t"\
"vmovapd %%ymm5, 128(%%r11)\n\t"\
"vmovapd %%ymm6, 160(%%r11)\n\t"\
"vmovapd %%ymm7, 192(%%r11)\n\t"\
"vmovapd %%ymm8, 224(%%r11)\n\t"\
"vfmadd132pd %%ymm9, %%ymm9, %%ymm9\n\t"\
"vmovapd %%ymm10, 256(%%r11)\n\t"\
"vmovapd %%ymm11, 288(%%r11)\n\t"\
"vmovapd %%ymm12, 320(%%r11)\n\t"\
"vmovapd %%ymm13, 352(%%r11)\n\t"\
"vfmadd132pd %%ymm14, %%ymm14, %%ymm14\n\t"\
"vmovapd %%ymm15, 384(%%r11)\n\t"\
"vmovapd %%ymm0, 416(%%r11)\n\t"\
"vmovapd %%ymm1, 448(%%r11)\n\t"\
"vmovapd %%ymm2, 480(%%r11)\n\t"\
"vfmadd132pd %%ymm3, %%ymm3, %%ymm3\n\t"\
"vmovapd %%ymm4, 512(%%r11)\n\t"\
"vmovapd %%ymm5, 544(%%r11)\n\t"\
"vmovapd %%ymm6, 576(%%r11)\n\t"\
"vmovapd %%ymm7, 608(%%r11)\n\t"\
"vfmadd132pd %%ymm8, %%ymm8, %%ymm8\n\t"\
"vmovapd %%ymm9, 640(%%r11)\n\t"\
"vmovapd %%ymm10, 672(%%r11)\n\t"\
"vmovapd %%ymm11, 704(%%r11)\n\t"\
"vmovapd %%ymm12, 736(%%r11)\n\t"\
"vfmadd132pd %%ymm13, %%ymm13, %%ymm13\n\t"\
"vmovapd %%ymm14, 768(%%r11)\n\t"\
"vmovapd %%ymm15, 800(%%r11)\n\t"\
"vmovapd %%ymm0, 832(%%r11)\n\t"\
"vmovapd %%ymm1, 864(%%r11)\n\t"\
"vfmadd132pd %%ymm2, %%ymm2, %%ymm2\n\t"\
"vmovapd %%ymm3, 896(%%r11)\n\t"\
"vmovapd %%ymm4, 928(%%r11)\n\t"\
"vmovapd %%ymm5, 960(%%r11)\n\t"\
"vmovapd %%ymm6, 992(%%r11)\n\t"\
"vfmadd132pd %%ymm7, %%ymm7, %%ymm7\n\t"\
"vmovapd %%ymm8, 1024(%%r11)\n\t"\
"vmovapd %%ymm9, 1056(%%r11)\n\t"\
"vmovapd %%ymm10, 1088(%%r11)\n\t"\
"vmovapd %%ymm11, 1120(%%r11)\n\t"\
"vfmadd132pd %%ymm12, %%ymm12, %%ymm12\n\t"\
"vmovapd %%ymm13, 1152(%%r11)\n\t"\
"vmovapd %%ymm14, 1184(%%r11)\n\t"\
"vmovapd %%ymm15, 1216(%%r11)\n\t"\
"vmovapd %%ymm0, 1248(%%r11)\n\t"\
"vfmadd132pd %%ymm1, %%ymm1, %%ymm1\n\t"\
"vmovapd %%ymm2, 1280(%%r11)\n\t"\
"vmovapd %%ymm3, 1312(%%r11)\n\t"\
"vmovapd %%ymm4, 1344(%%r11)\n\t"\
"vmovapd %%ymm5, 1376(%%r11)\n\t"\
"vfmadd132pd %%ymm6, %%ymm6, %%ymm6\n\t"\
"vmovapd %%ymm7, 1408(%%r11)\n\t"\
"vmovapd %%ymm8, 1440(%%r11)\n\t"\
"vmovapd %%ymm9, 1472(%%r11)\n\t"\
"vmovapd %%ymm10, 1504(%%r11)\n\t"\
"vfmadd132pd %%ymm11, %%ymm11, %%ymm11\n\t"\
"vmovapd %%ymm12, 1536(%%r11)\n\t"\
"vmovapd %%ymm13, 1568(%%r11)\n\t"\
"vmovapd %%ymm14, 1600(%%r11)\n\t"\
"vmovapd %%ymm15, 1632(%%r11)\n\t"\
"vfmadd132pd %%ymm0, %%ymm0, %%ymm0\n\t"\
"vmovapd %%ymm1, 1664(%%r11)\n\t"\
"vmovapd %%ymm2, 1696(%%r11)\n\t"\
"vmovapd %%ymm3, 1728(%%r11)\n\t"\
"vmovapd %%ymm4, 1760(%%r11)\n\t"\
"vfmadd132pd %%ymm5, %%ymm5, %%ymm5\n\t"\
"vmovapd %%ymm6, 1792(%%r11)\n\t"\
"vmovapd %%ymm7, 1824(%%r11)\n\t"\
"vmovapd %%ymm8, 1856(%%r11)\n\t"\
"vmovapd %%ymm9, 1888(%%r11)\n\t"\
"vfmadd132pd %%ymm10, %%ymm10, %%ymm10\n\t"\
"add $1920, %%r11\n\t"\
"sub $1920, %%r12\n\t"\
"jnz buffer_STORE_FMA_increment\n\t"\
"sub $1, %0\n\t"\
"jnz loop_STORE_FMA_repeat\n\t"\
...
roofline_output_end_measure(out, repeat*data->size, repeat*data->size*120/1920, repeat*data->size*75/1920);
...
roofline_output_begin_measure(out);
__asm__ __volatile__ (\
"loop_STORE_FMA_validation_repeat:\n\t"\
"mov %1, %%r11\n\t"\
"mov %2, %%r12\n\t"\
"buffer_STORE_FMA_validation_increment:\n\t"\
"add $1920, %%r11\n\t"\
"sub $1920, %%r12\n\t"\
"jnz buffer_STORE_FMA_validation_increment\n\t"\
"sub $1, %0\n\t"\
"jnz loop_STORE_FMA_validation_repeat\n\t"\
