...
"vmovapd %%ymm11, 672(%%r11)\n\t"\
"vmovapd 704(%%r11), %%ymm12\n\t"\
"vmovapd 736(%%r11), %%ymm13\n\t"\
"vmovapd %%ymm14, 768(%%r11)\n\t"\
"vmovapd 800(%%r11), %%ymm15\n\t"\
"vmovapd 832(%%r11), %%ymm0\n\t"\
...
"vmovapd 1120(%%r11), %%ymm13\n\t"\
"vmovapd %%ymm14, 1152(%%r11)\n\t"\
"vmovapd 1184(%%r11), %%ymm15\n\t"\
"vmovapd 1216(%%r11), %%ymm0\n\t"\
"vmovapd %%ymm1, 1248(%%r11)\n\t"\
"vmovapd 1280(%%r11), %%ymm2\n\t"\
"vmovapd 1312(%%r11), %%ymm3\n\t"\
"vaddpd %%ymm4, %%ymm4, %%ymm4\n\t"\
"vmulpd %%ymm5, %%ymm5, %%ymm5\n\t"\
"vmovapd %%ymm6, 1344(%%r11)\n\t"\
"vmovapd 1376(%%r11), %%ymm7\n\t"\
"vmovapd 1408(%%r11), %%ymm8\n\t"\
"vmovapd %%ymm9, 1440(%%r11)\n\t"\
"vmovapd 1472(%%r11), %%ymm10\n\t"\
"vmovapd 1504(%%r11), %%ymm11\n\t"\
"vmovapd %%ymm12, 1536(%%r11)\n\t"\
"vaddpd %%ymm13, %%ymm13, %%ymm13\n\t"\
"vmulpd %%ymm14, %%ymm14, %%ymm14\n\t"\
"vmovapd 1568(%%r11), %%ymm15\n\t"\
"vmovapd 1600(%%r11), %%ymm0\n\t"\
"vmovapd %%ymm1, 1632(%%r11)\n\t"\
"vmovapd 1664(%%r11), %%ymm2\n\t"\
"vmovapd 1696(%%r11), %%ymm3\n\t"\
"vmovapd %%ymm4, 1728(%%r11)\n\t"\
"vmovapd 1760(%%r11), %%ymm5\n\t"\
...
roofline_output_end_measure(out, repeat*data->size, repeat*data->size*72/2016, repeat*data->size*81/2016);
