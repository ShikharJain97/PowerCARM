...
"vmovapd %%ymm9, 256(%%r11)\n\t"\
"vmovapd %%ymm10, 288(%%r11)\n\t"\
"vfmadd132pd %%ymm11, %%ymm11, %%ymm11\n\t"\
"vmovapd %%ymm12, 320(%%r11)\n\t"\
"vmovapd %%ymm13, 352(%%r11)\n\t"\
"vmovapd %%ymm14, 384(%%r11)\n\t"\
"vmovapd %%ymm15, 416(%%r11)\n\t"\
"vmovapd %%ymm0, 448(%%r11)\n\t"\
"vfmadd132pd %%ymm1, %%ymm1, %%ymm1\n\t"\
"vmovapd %%ymm2, 480(%%r11)\n\t"\
"vmovapd %%ymm3, 512(%%r11)\n\t"\
"vmovapd %%ymm4, 544(%%r11)\n\t"\
"vmovapd %%ymm5, 576(%%r11)\n\t"\
"vmovapd %%ymm6, 608(%%r11)\n\t"\
"vfmadd132pd %%ymm7, %%ymm7, %%ymm7\n\t"\
"vmovapd %%ymm8, 640(%%r11)\n\t"\
"vmovapd %%ymm9, 672(%%r11)\n\t"\
"vmovapd %%ymm10, 704(%%r11)\n\t"\
"vmovapd %%ymm11, 736(%%r11)\n\t"\
"vmovapd %%ymm12, 768(%%r11)\n\t"\
"vfmadd132pd %%ymm13, %%ymm13, %%ymm13\n\t"\
"vmovapd %%ymm14, 800(%%r11)\n\t"\
"vmovapd %%ymm15, 832(%%r11)\n\t"\
"vmovapd %%ymm0, 864(%%r11)\n\t"\
"vmovapd %%ymm1, 896(%%r11)\n\t"\
"vmovapd %%ymm2, 928(%%r11)\n\t"\
"vfmadd132pd %%ymm3, %%ymm3, %%ymm3\n\t"\
"vmovapd %%ymm4, 960(%%r11)\n\t"\
"vmovapd %%ymm5, 992(%%r11)\n\t"\
"vmovapd %%ymm6, 1024(%%r11)\n\t"\
"vmovapd %%ymm7, 1056(%%r11)\n\t"\
"vmovapd %%ymm8, 1088(%%r11)\n\t"\
"vfmadd132pd %%ymm9, %%ymm9, %%ymm9\n\t"\
"vmovapd %%ymm10, 1120(%%r11)\n\t"\
"vmovapd %%ymm11, 1152(%%r11)\n\t"\
"vmovapd %%ymm12, 1184(%%r11)\n\t"\
"vmovapd %%ymm13, 1216(%%r11)\n\t"\
"vmovapd %%ymm14, 1248(%%r11)\n\t"\
"vfmadd132pd %%ymm15, %%ymm15, %%ymm15\n\t"\
"vmovapd %%ymm0, 1280(%%r11)\n\t"\
"vmovapd %%ymm1, 1312(%%r11)\n\t"\
"vmovapd %%ymm2, 1344(%%r11)\n\t"\
"vmovapd %%ymm3, 1376(%%r11)\n\t"\
"vmovapd %%ymm4, 1408(%%r11)\n\t"\
"vfmadd132pd %%ymm5, %%ymm5, %%ymm5\n\t"\
"vmovapd %%ymm6, 1440(%%r11)\n\t"\
"vmovapd %%ymm7, 1472(%%r11)\n\t"\
"vmovapd %%ymm8, 1504(%%r11)\n\t"\
"vmovapd %%ymm9, 1536(%%r11)\n\t"\
"vmovapd %%ymm10, 1568(%%r11)\n\t"\
"vfmadd132pd %%ymm11, %%ymm11, %%ymm11\n\t"\
"vmovapd %%ymm12, 1600(%%r11)\n\t"\
"vmovapd %%ymm13, 1632(%%r11)\n\t"\
"vmovapd %%ymm14, 1664(%%r11)\n\t"\
"vmovapd %%ymm15, 1696(%%r11)\n\t"\
"vmovapd %%ymm0, 1728(%%r11)\n\t"\
"vfmadd132pd %%ymm1, %%ymm1, %%ymm1\n\t"\
"vmovapd %%ymm2, 1760(%%r11)\n\t"\
"vmovapd %%ymm3, 1792(%%r11)\n\t"\
"vmovapd %%ymm4, 1824(%%r11)\n\t"\
"vmovapd %%ymm5, 1856(%%r11)\n\t"\
"vmovapd %%ymm6, 1888(%%r11)\n\t"\
"vfmadd132pd %%ymm7, %%ymm7, %%ymm7\n\t"\
"add $1920, %%r11\n\t"\
"sub $1920, %%r12\n\t"\
...
roofline_output_end_measure(out, repeat*data->size, repeat*data->size*96/1920, repeat*data->size*72/1920);
