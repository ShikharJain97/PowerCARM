...
__asm__ __volatile__ (\
"loop_STORE_NT_MAD_repeat:\n\t"\
"mov %1, %%r11\n\t"\
"mov %2, %%r12\n\t"\
"buffer_STORE_NT_MAD_increment:\n\t"\
"vmovntpd %%ymm0, 0(%%r11)\n\t"\
...
"vmovntpd %%ymm14, 320(%%r11)\n\t"\
"vmovntpd %%ymm15, 352(%%r11)\n\t"\
"vmovntpd %%ymm0, 384(%%r11)\n\t"\
"vmovntpd %%ymm1, 416(%%r11)\n\t"\
"vmovntpd %%ymm2, 448(%%r11)\n\t"\
"vmovntpd %%ymm3, 480(%%r11)\n\t"\
"vmovntpd %%ymm4, 512(%%r11)\n\t"\
"vmovntpd %%ymm5, 544(%%r11)\n\t"\
"vaddpd %%ymm6, %%ymm6, %%ymm6\n\t"\
"vmulpd %%ymm7, %%ymm7, %%ymm7\n\t"\
"vaddpd %%ymm8, %%ymm8, %%ymm8\n\t"\
"vmulpd %%ymm9, %%ymm9, %%ymm9\n\t"\
"vmovntpd %%ymm10, 576(%%r11)\n\t"\
"vmovntpd %%ymm11, 608(%%r11)\n\t"\
"vmovntpd %%ymm12, 640(%%r11)\n\t"\
"vmovntpd %%ymm13, 672(%%r11)\n\t"\
"vmovntpd %%ymm14, 704(%%r11)\n\t"\
"vmovntpd %%ymm15, 736(%%r11)\n\t"\
"vmovntpd %%ymm0, 768(%%r11)\n\t"\
"vmovntpd %%ymm1, 800(%%r11)\n\t"\
"vmovntpd %%ymm2, 832(%%r11)\n\t"\
"vaddpd %%ymm3, %%ymm3, %%ymm3\n\t"\
"vmulpd %%ymm4, %%ymm4, %%ymm4\n\t"\
"vaddpd %%ymm5, %%ymm5, %%ymm5\n\t"\
"vmulpd %%ymm6, %%ymm6, %%ymm6\n\t"\
"vmovntpd %%ymm7, 864(%%r11)\n\t"\
"vmovntpd %%ymm8, 896(%%r11)\n\t"\
"vmovntpd %%ymm9, 928(%%r11)\n\t"\
"vmovntpd %%ymm10, 960(%%r11)\n\t"\
"vmovntpd %%ymm11, 992(%%r11)\n\t"\
"vmovntpd %%ymm12, 1024(%%r11)\n\t"\
"vmovntpd %%ymm13, 1056(%%r11)\n\t"\
"vmovntpd %%ymm14, 1088(%%r11)\n\t"\
"vmovntpd %%ymm15, 1120(%%r11)\n\t"\
"vaddpd %%ymm0, %%ymm0, %%ymm0\n\t"\
"vmulpd %%ymm1, %%ymm1, %%ymm1\n\t"\
"vaddpd %%ymm2, %%ymm2, %%ymm2\n\t"\
"vmulpd %%ymm3, %%ymm3, %%ymm3\n\t"\
"vmovntpd %%ymm4, 1152(%%r11)\n\t"\
"vmovntpd %%ymm5, 1184(%%r11)\n\t"\
"vmovntpd %%ymm6, 1216(%%r11)\n\t"\
"vmovntpd %%ymm7, 1248(%%r11)\n\t"\
"vmovntpd %%ymm8, 1280(%%r11)\n\t"\
"vmovntpd %%ymm9, 1312(%%r11)\n\t"\
"vmovntpd %%ymm10, 1344(%%r11)\n\t"\
"vmovntpd %%ymm11, 1376(%%r11)\n\t"\
"vmovntpd %%ymm12, 1408(%%r11)\n\t"\
"vaddpd %%ymm13, %%ymm13, %%ymm13\n\t"\
"vmulpd %%ymm14, %%ymm14, %%ymm14\n\t"\
"vaddpd %%ymm15, %%ymm15, %%ymm15\n\t"\
"vmulpd %%ymm0, %%ymm0, %%ymm0\n\t"\
"vmovntpd %%ymm1, 1440(%%r11)\n\t"\
"vmovntpd %%ymm2, 1472(%%r11)\n\t"\
"vmovntpd %%ymm3, 1504(%%r11)\n\t"\
"vmovntpd %%ymm4, 1536(%%r11)\n\t"\
"vmovntpd %%ymm5, 1568(%%r11)\n\t"\
"vmovntpd %%ymm6, 1600(%%r11)\n\t"\
"vmovntpd %%ymm7, 1632(%%r11)\n\t"\
"vmovntpd %%ymm8, 1664(%%r11)\n\t"\
"vmovntpd %%ymm9, 1696(%%r11)\n\t"\
...
"add $1728, %%r11\n\t"\
"sub $1728, %%r12\n\t"\
"jnz buffer_STORE_NT_MAD_increment\n\t"\
"sub $1, %0\n\t"\
"jnz loop_STORE_NT_MAD_repeat\n\t"\
...
roofline_output_end_measure(out, repeat*data->size, repeat*data->size*96/1728, repeat*data->size*78/1728);
...
roofline_output_begin_measure(out);
__asm__ __volatile__ (\
"loop_STORE_NT_MAD_validation_repeat:\n\t"\
"mov %1, %%r11\n\t"\
"mov %2, %%r12\n\t"\
"buffer_STORE_NT_MAD_validation_increment:\n\t"\
"add $1728, %%r11\n\t"\
"sub $1728, %%r12\n\t"\
"jnz buffer_STORE_NT_MAD_validation_increment\n\t"\
"sub $1, %0\n\t"\
"jnz loop_STORE_NT_MAD_validation_repeat\n\t"\
