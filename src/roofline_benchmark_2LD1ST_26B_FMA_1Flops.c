...
__asm__ __volatile__ (\
"loop_2LD1ST_FMA_repeat:\n\t"\
"mov %1, %%r11\n\t"\
"mov %2, %%r12\n\t"\
"buffer_2LD1ST_FMA_increment:\n\t"\
"vmovapd %%ymm0, 0(%%r11)\n\t"\
"vmovapd 32(%%r11), %%ymm1\n\t"\
"vmovapd 64(%%r11), %%ymm2\n\t"\
"vmovapd %%ymm3, 96(%%r11)\n\t"\
...
"vmovapd 256(%%r11), %%ymm8\n\t"\
"vmovapd %%ymm9, 288(%%r11)\n\t"\
"vmovapd 320(%%r11), %%ymm10\n\t"\
"vmovapd 352(%%r11), %%ymm11\n\t"\
"vmovapd %%ymm12, 384(%%r11)\n\t"\
"vfmadd132pd %%ymm13, %%ymm13, %%ymm13\n\t"\
"vfmadd132pd %%ymm14, %%ymm14, %%ymm14\n\t"\
"vmovapd 416(%%r11), %%ymm15\n\t"\
"vmovapd 448(%%r11), %%ymm0\n\t"\
"vmovapd %%ymm1, 480(%%r11)\n\t"\
"vmovapd 512(%%r11), %%ymm2\n\t"\
"vmovapd 544(%%r11), %%ymm3\n\t"\
"vmovapd %%ymm4, 576(%%r11)\n\t"\
"vmovapd 608(%%r11), %%ymm5\n\t"\
"vmovapd 640(%%r11), %%ymm6\n\t"\
"vmovapd %%ymm7, 672(%%r11)\n\t"\
"vmovapd 704(%%r11), %%ymm8\n\t"\
"vmovapd 736(%%r11), %%ymm9\n\t"\
"vmovapd %%ymm10, 768(%%r11)\n\t"\
"vmovapd 800(%%r11), %%ymm11\n\t"\
"vfmadd132pd %%ymm12, %%ymm12, %%ymm12\n\t"\
"vfmadd132pd %%ymm13, %%ymm13, %%ymm13\n\t"\
"vmovapd 832(%%r11), %%ymm14\n\t"\
"vmovapd %%ymm15, 864(%%r11)\n\t"\
"vmovapd 896(%%r11), %%ymm0\n\t"\
"vmovapd 928(%%r11), %%ymm1\n\t"\
"vmovapd %%ymm2, 960(%%r11)\n\t"\
"vmovapd 992(%%r11), %%ymm3\n\t"\
"vmovapd 1024(%%r11), %%ymm4\n\t"\
"vmovapd %%ymm5, 1056(%%r11)\n\t"\
"vmovapd 1088(%%r11), %%ymm6\n\t"\
...
"vfmadd132pd %%ymm12, %%ymm12, %%ymm12\n\t"\
"vmovapd %%ymm13, 1248(%%r11)\n\t"\
"vmovapd 1280(%%r11), %%ymm14\n\t"\
"vmovapd 1312(%%r11), %%ymm15\n\t"\
"vmovapd %%ymm0, 1344(%%r11)\n\t"\
"vmovapd 1376(%%r11), %%ymm1\n\t"\
"vmovapd 1408(%%r11), %%ymm2\n\t"\
"vmovapd %%ymm3, 1440(%%r11)\n\t"\
"vmovapd 1472(%%r11), %%ymm4\n\t"\
"vmovapd 1504(%%r11), %%ymm5\n\t"\
"vmovapd %%ymm6, 1536(%%r11)\n\t"\
"vmovapd 1568(%%r11), %%ymm7\n\t"\
"vmovapd 1600(%%r11), %%ymm8\n\t"\
"vmovapd %%ymm9, 1632(%%r11)\n\t"\
"vfmadd132pd %%ymm10, %%ymm10, %%ymm10\n\t"\
"vfmadd132pd %%ymm11, %%ymm11, %%ymm11\n\t"\
"vmovapd 1664(%%r11), %%ymm12\n\t"\
"vmovapd 1696(%%r11), %%ymm13\n\t"\
"vmovapd %%ymm14, 1728(%%r11)\n\t"\
"vmovapd 1760(%%r11), %%ymm15\n\t"\
"vmovapd 1792(%%r11), %%ymm0\n\t"\
"vmovapd %%ymm1, 1824(%%r11)\n\t"\
"vmovapd 1856(%%r11), %%ymm2\n\t"\
"vmovapd 1888(%%r11), %%ymm3\n\t"\
"vmovapd %%ymm4, 1920(%%r11)\n\t"\
"vmovapd 1952(%%r11), %%ymm5\n\t"\
"vmovapd 1984(%%r11), %%ymm6\n\t"\
"vmovapd %%ymm7, 2016(%%r11)\n\t"\
"vmovapd 2048(%%r11), %%ymm8\n\t"\
"vfmadd132pd %%ymm9, %%ymm9, %%ymm9\n\t"\
"vfmadd132pd %%ymm10, %%ymm10, %%ymm10\n\t"\
"vmovapd 2080(%%r11), %%ymm11\n\t"\
"vmovapd %%ymm12, 2112(%%r11)\n\t"\
"vmovapd 2144(%%r11), %%ymm13\n\t"\
"vmovapd 2176(%%r11), %%ymm14\n\t"\
"vmovapd %%ymm15, 2208(%%r11)\n\t"\
"vmovapd 2240(%%r11), %%ymm0\n\t"\
"vmovapd 2272(%%r11), %%ymm1\n\t"\
"vmovapd %%ymm2, 2304(%%r11)\n\t"\
"vmovapd 2336(%%r11), %%ymm3\n\t"\
"vmovapd 2368(%%r11), %%ymm4\n\t"\
"vmovapd %%ymm5, 2400(%%r11)\n\t"\
"vmovapd 2432(%%r11), %%ymm6\n\t"\
"vmovapd 2464(%%r11), %%ymm7\n\t"\
"vfmadd132pd %%ymm8, %%ymm8, %%ymm8\n\t"\
"vfmadd132pd %%ymm9, %%ymm9, %%ymm9\n\t"\
"add $2496, %%r11\n\t"\
"sub $2496, %%r12\n\t"\
"jnz buffer_2LD1ST_FMA_increment\n\t"\
"sub $1, %0\n\t"\
"jnz loop_2LD1ST_FMA_repeat\n\t"\
...
roofline_output_end_measure(out, repeat*data->size, repeat*data->size*96/2496, repeat*data->size*90/2496);
...
roofline_output_begin_measure(out);
__asm__ __volatile__ (\
"loop_2LD1ST_FMA_validation_repeat:\n\t"\
"mov %1, %%r11\n\t"\
"mov %2, %%r12\n\t"\
"buffer_2LD1ST_FMA_validation_increment:\n\t"\
"add $2496, %%r11\n\t"\
"sub $2496, %%r12\n\t"\
"jnz buffer_2LD1ST_FMA_validation_increment\n\t"\
"sub $1, %0\n\t"\
"jnz loop_2LD1ST_FMA_validation_repeat\n\t"\
