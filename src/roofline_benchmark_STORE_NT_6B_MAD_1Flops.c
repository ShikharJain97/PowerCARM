...
"vmovntpd %%ymm7, 96(%%r11)\n\t"\
"vmovntpd %%ymm8, 128(%%r11)\n\t"\
"vmovntpd %%ymm9, 160(%%r11)\n\t"\
"vaddpd %%ymm10, %%ymm10, %%ymm10\n\t"\
"vmulpd %%ymm11, %%ymm11, %%ymm11\n\t"\
"vaddpd %%ymm12, %%ymm12, %%ymm12\n\t"\
"vmulpd %%ymm13, %%ymm13, %%ymm13\n\t"\
"vmovntpd %%ymm14, 192(%%r11)\n\t"\
"vmovntpd %%ymm15, 224(%%r11)\n\t"\
"vmovntpd %%ymm0, 256(%%r11)\n\t"\
"vaddpd %%ymm1, %%ymm1, %%ymm1\n\t"\
"vmulpd %%ymm2, %%ymm2, %%ymm2\n\t"\
"vaddpd %%ymm3, %%ymm3, %%ymm3\n\t"\
"vmulpd %%ymm4, %%ymm4, %%ymm4\n\t"\
"vmovntpd %%ymm5, 288(%%r11)\n\t"\
"vmovntpd %%ymm6, 320(%%r11)\n\t"\
"vmovntpd %%ymm7, 352(%%r11)\n\t"\
...
"vaddpd %%ymm15, %%ymm15, %%ymm15\n\t"\
"vmulpd %%ymm0, %%ymm0, %%ymm0\n\t"\
"vmovntpd %%ymm1, 672(%%r11)\n\t"\
"vmovntpd %%ymm2, 704(%%r11)\n\t"\
"vmovntpd %%ymm3, 736(%%r11)\n\t"\
...
roofline_output_end_measure(out, repeat*data->size, repeat*data->size*176/1056, repeat*data->size*77/1056);
