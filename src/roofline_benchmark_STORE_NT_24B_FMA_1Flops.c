...
"vmovntpd %%ymm9, 256(%%r11)\n\t"\
"vmovntpd %%ymm10, 288(%%r11)\n\t"\
"vmovntpd %%ymm11, 320(%%r11)\n\t"\
"vmovntpd %%ymm12, 352(%%r11)\n\t"\
...
"vmovntpd %%ymm5, 576(%%r11)\n\t"\
"vmovntpd %%ymm6, 608(%%r11)\n\t"\
"vmovntpd %%ymm7, 640(%%r11)\n\t"\
"vmovntpd %%ymm8, 672(%%r11)\n\t"\
"vmovntpd %%ymm9, 704(%%r11)\n\t"\
"vmovntpd %%ymm10, 736(%%r11)\n\t"\
...
"vmovntpd %%ymm3, 960(%%r11)\n\t"\
"vmovntpd %%ymm4, 992(%%r11)\n\t"\
"vmovntpd %%ymm5, 1024(%%r11)\n\t"\
"vmovntpd %%ymm6, 1056(%%r11)\n\t"\
"vmovntpd %%ymm7, 1088(%%r11)\n\t"\
"vmovntpd %%ymm8, 1120(%%r11)\n\t"\
...
"vmovntpd %%ymm1, 1344(%%r11)\n\t"\
"vmovntpd %%ymm2, 1376(%%r11)\n\t"\
"vmovntpd %%ymm3, 1408(%%r11)\n\t"\
"vmovntpd %%ymm4, 1440(%%r11)\n\t"\
...
"vmovntpd %%ymm15, 1728(%%r11)\n\t"\
"vmovntpd %%ymm0, 1760(%%r11)\n\t"\
"vmovntpd %%ymm1, 1792(%%r11)\n\t"\
"vmovntpd %%ymm2, 1824(%%r11)\n\t"\
"vmovntpd %%ymm3, 1856(%%r11)\n\t"\
"vmovntpd %%ymm4, 1888(%%r11)\n\t"\
...
roofline_output_end_measure(out, repeat*data->size, repeat*data->size*88/2112, repeat*data->size*77/2112);
