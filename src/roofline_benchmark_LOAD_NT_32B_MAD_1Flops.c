...
"vmovapd 128(%%r11), %%ymm5\n\t"\
"vmovapd 160(%%r11), %%ymm6\n\t"\
"vmovapd 192(%%r11), %%ymm7\n\t"\
"vmovapd 224(%%r11), %%ymm8\n\t"\
"vmulpd %%ymm9, %%ymm9, %%ymm9\n\t"\
"vmovapd 256(%%r11), %%ymm10\n\t"\
"vmovapd 288(%%r11), %%ymm11\n\t"\
"vmovapd 320(%%r11), %%ymm12\n\t"\
"vmovapd 352(%%r11), %%ymm13\n\t"\
"vaddpd %%ymm14, %%ymm14, %%ymm14\n\t"\
"vmovapd 384(%%r11), %%ymm15\n\t"\
"vmovapd 416(%%r11), %%ymm0\n\t"\
"vmovapd 448(%%r11), %%ymm1\n\t"\
"vmovapd 480(%%r11), %%ymm2\n\t"\
...
"vmovapd 640(%%r11), %%ymm9\n\t"\
"vmovapd 672(%%r11), %%ymm10\n\t"\
"vmovapd 704(%%r11), %%ymm11\n\t"\
"vmovapd 736(%%r11), %%ymm12\n\t"\
"vmulpd %%ymm13, %%ymm13, %%ymm13\n\t"\
"vmovapd 768(%%r11), %%ymm14\n\t"\
"vmovapd 800(%%r11), %%ymm15\n\t"\
"vmovapd 832(%%r11), %%ymm0\n\t"\
"vmovapd 864(%%r11), %%ymm1\n\t"\
"vaddpd %%ymm2, %%ymm2, %%ymm2\n\t"\
"vmovapd 896(%%r11), %%ymm3\n\t"\
"vmovapd 928(%%r11), %%ymm4\n\t"\
"vmovapd 960(%%r11), %%ymm5\n\t"\
"vmovapd 992(%%r11), %%ymm6\n\t"\
...
"vmovapd 1152(%%r11), %%ymm13\n\t"\
"vmovapd 1184(%%r11), %%ymm14\n\t"\
"vmovapd 1216(%%r11), %%ymm15\n\t"\
"vmovapd 1248(%%r11), %%ymm0\n\t"\
"vmulpd %%ymm1, %%ymm1, %%ymm1\n\t"\
"vmovapd 1280(%%r11), %%ymm2\n\t"\
"vmovapd 1312(%%r11), %%ymm3\n\t"\
"vmovapd 1344(%%r11), %%ymm4\n\t"\
"vmovapd 1376(%%r11), %%ymm5\n\t"\
"vaddpd %%ymm6, %%ymm6, %%ymm6\n\t"\
"vmovapd 1408(%%r11), %%ymm7\n\t"\
"vmovapd 1440(%%r11), %%ymm8\n\t"\
"vmovapd 1472(%%r11), %%ymm9\n\t"\
"vmovapd 1504(%%r11), %%ymm10\n\t"\
...
"vmovapd 1664(%%r11), %%ymm1\n\t"\
"vmovapd 1696(%%r11), %%ymm2\n\t"\
"vmovapd 1728(%%r11), %%ymm3\n\t"\
"vmovapd 1760(%%r11), %%ymm4\n\t"\
"vmulpd %%ymm5, %%ymm5, %%ymm5\n\t"\
"vmovapd 1792(%%r11), %%ymm6\n\t"\
"vmovapd 1824(%%r11), %%ymm7\n\t"\
"vmovapd 1856(%%r11), %%ymm8\n\t"\
"vmovapd 1888(%%r11), %%ymm9\n\t"\
...
roofline_output_end_measure(out, repeat*data->size, repeat*data->size*60/1920, repeat*data->size*75/1920);
