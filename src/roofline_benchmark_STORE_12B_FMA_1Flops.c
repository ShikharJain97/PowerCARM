...
"vmovapd %%ymm12, 288(%%r11)\n\t"\
"vmovapd %%ymm13, 320(%%r11)\n\t"\
"vmovapd %%ymm14, 352(%%r11)\n\t"\
"vfmadd132pd %%ymm15, %%ymm15, %%ymm15\n\t"\
"vmovapd %%ymm0, 384(%%r11)\n\t"\
"vmovapd %%ymm1, 416(%%r11)\n\t"\
"vmovapd %%ymm2, 448(%%r11)\n\t"\
"vfmadd132pd %%ymm3, %%ymm3, %%ymm3\n\t"\
"vmovapd %%ymm4, 480(%%r11)\n\t"\
"vmovapd %%ymm5, 512(%%r11)\n\t"\
"vmovapd %%ymm6, 544(%%r11)\n\t"\
"vfmadd132pd %%ymm7, %%ymm7, %%ymm7\n\t"\
"vmovapd %%ymm8, 576(%%r11)\n\t"\
"vmovapd %%ymm9, 608(%%r11)\n\t"\
"vmovapd %%ymm10, 640(%%r11)\n\t"\
"vfmadd132pd %%ymm11, %%ymm11, %%ymm11\n\t"\
"vmovapd %%ymm12, 672(%%r11)\n\t"\
"vmovapd %%ymm13, 704(%%r11)\n\t"\
"vmovapd %%ymm14, 736(%%r11)\n\t"\
"vfmadd132pd %%ymm15, %%ymm15, %%ymm15\n\t"\
"add $768, %%r11\n\t"\
"sub $768, %%r12\n\t"\
...
roofline_output_end_measure(out, repeat*data->size, repeat*data->size*64/768, repeat*data->size*32/768);
