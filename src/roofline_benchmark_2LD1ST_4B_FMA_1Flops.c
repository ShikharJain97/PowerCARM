...
"vmovapd %%ymm12, 192(%%r11)\n\t"\
"vfmadd132pd %%ymm13, %%ymm13, %%ymm13\n\t"\
"vmovapd 224(%%r11), %%ymm14\n\t"\
"vfmadd132pd %%ymm15, %%ymm15, %%ymm15\n\t"\
"vmovapd 256(%%r11), %%ymm0\n\t"\
"vfmadd132pd %%ymm1, %%ymm1, %%ymm1\n\t"\
"vmovapd %%ymm2, 288(%%r11)\n\t"\
"vfmadd132pd %%ymm3, %%ymm3, %%ymm3\n\t"\
"vmovapd 320(%%r11), %%ymm4\n\t"\
"vfmadd132pd %%ymm5, %%ymm5, %%ymm5\n\t"\
"vmovapd 352(%%r11), %%ymm6\n\t"\
"vfmadd132pd %%ymm7, %%ymm7, %%ymm7\n\t"\
"vmovapd %%ymm8, 384(%%r11)\n\t"\
"vfmadd132pd %%ymm9, %%ymm9, %%ymm9\n\t"\
"vmovapd 416(%%r11), %%ymm10\n\t"\
"vfmadd132pd %%ymm11, %%ymm11, %%ymm11\n\t"\
"vmovapd 448(%%r11), %%ymm12\n\t"\
"vfmadd132pd %%ymm13, %%ymm13, %%ymm13\n\t"\
"vmovapd %%ymm14, 480(%%r11)\n\t"\
"vfmadd132pd %%ymm15, %%ymm15, %%ymm15\n\t"\
"vmovapd 512(%%r11), %%ymm0\n\t"\
"vfmadd132pd %%ymm1, %%ymm1, %%ymm1\n\t"\
"vmovapd 544(%%r11), %%ymm2\n\t"\
"vfmadd132pd %%ymm3, %%ymm3, %%ymm3\n\t"\
...
"vfmadd132pd %%ymm13, %%ymm13, %%ymm13\n\t"\
"vmovapd 736(%%r11), %%ymm14\n\t"\
"vfmadd132pd %%ymm15, %%ymm15, %%ymm15\n\t"\
"vmovapd %%ymm0, 768(%%r11)\n\t"\
"vfmadd132pd %%ymm1, %%ymm1, %%ymm1\n\t"\
"vmovapd 800(%%r11), %%ymm2\n\t"\
"vfmadd132pd %%ymm3, %%ymm3, %%ymm3\n\t"\
"vmovapd 832(%%r11), %%ymm4\n\t"\
"vfmadd132pd %%ymm5, %%ymm5, %%ymm5\n\t"\
"vmovapd %%ymm6, 864(%%r11)\n\t"\
"vfmadd132pd %%ymm7, %%ymm7, %%ymm7\n\t"\
"vmovapd 896(%%r11), %%ymm8\n\t"\
"vfmadd132pd %%ymm9, %%ymm9, %%ymm9\n\t"\
"vmovapd 928(%%r11), %%ymm10\n\t"\
"vfmadd132pd %%ymm11, %%ymm11, %%ymm11\n\t"\
"vmovapd %%ymm12, 960(%%r11)\n\t"\
"vfmadd132pd %%ymm13, %%ymm13, %%ymm13\n\t"\
"vmovapd 992(%%r11), %%ymm14\n\t"\
"vfmadd132pd %%ymm15, %%ymm15, %%ymm15\n\t"\
"vmovapd 1024(%%r11), %%ymm0\n\t"\
"vfmadd132pd %%ymm1, %%ymm1, %%ymm1\n\t"\
"vmovapd %%ymm2, 1056(%%r11)\n\t"\
"vfmadd132pd %%ymm3, %%ymm3, %%ymm3\n\t"\
"vmovapd 1088(%%r11), %%ymm4\n\t"\
"vfmadd132pd %%ymm5, %%ymm5, %%ymm5\n\t"\
"vmovapd 1120(%%r11), %%ymm6\n\t"\
"vfmadd132pd %%ymm7, %%ymm7, %%ymm7\n\t"\
"add $1152, %%r11\n\t"\
"sub $1152, %%r12\n\t"\
...
roofline_output_end_measure(out, repeat*data->size, repeat*data->size*288/1152, repeat*data->size*72/1152);
