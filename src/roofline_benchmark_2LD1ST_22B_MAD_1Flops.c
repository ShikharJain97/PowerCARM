...
"vmovapd 448(%%r11), %%ymm2\n\t"\
"vmovapd %%ymm3, 480(%%r11)\n\t"\
"vmovapd 512(%%r11), %%ymm4\n\t"\
"vmovapd 544(%%r11), %%ymm5\n\t"\
"vmovapd %%ymm6, 576(%%r11)\n\t"\
"vmovapd 608(%%r11), %%ymm7\n\t"\
"vmovapd 640(%%r11), %%ymm8\n\t"\
"vmovapd %%ymm9, 672(%%r11)\n\t"\
"vaddpd %%ymm10, %%ymm10, %%ymm10\n\t"\
"vmulpd %%ymm11, %%ymm11, %%ymm11\n\t"\
"vaddpd %%ymm12, %%ymm12, %%ymm12\n\t"\
"vmulpd %%ymm13, %%ymm13, %%ymm13\n\t"\
"vmovapd 704(%%r11), %%ymm14\n\t"\
"vmovapd 736(%%r11), %%ymm15\n\t"\
"vmovapd %%ymm0, 768(%%r11)\n\t"\
"vmovapd 800(%%r11), %%ymm1\n\t"\
"vmovapd 832(%%r11), %%ymm2\n\t"\
"vmovapd %%ymm3, 864(%%r11)\n\t"\
"vmovapd 896(%%r11), %%ymm4\n\t"\
"vmovapd 928(%%r11), %%ymm5\n\t"\
"vmovapd %%ymm6, 960(%%r11)\n\t"\
"vmovapd 992(%%r11), %%ymm7\n\t"\
"vmovapd 1024(%%r11), %%ymm8\n\t"\
"vaddpd %%ymm9, %%ymm9, %%ymm9\n\t"\
"vmulpd %%ymm10, %%ymm10, %%ymm10\n\t"\
"vaddpd %%ymm11, %%ymm11, %%ymm11\n\t"\
"vmulpd %%ymm12, %%ymm12, %%ymm12\n\t"\
"vmovapd %%ymm13, 1056(%%r11)\n\t"\
"vmovapd 1088(%%r11), %%ymm14\n\t"\
"vmovapd 1120(%%r11), %%ymm15\n\t"\
"vmovapd %%ymm0, 1152(%%r11)\n\t"\
"vmovapd 1184(%%r11), %%ymm1\n\t"\
"vmovapd 1216(%%r11), %%ymm2\n\t"\
"vmovapd %%ymm3, 1248(%%r11)\n\t"\
"vmovapd 1280(%%r11), %%ymm4\n\t"\
"vmovapd 1312(%%r11), %%ymm5\n\t"\
"vmovapd %%ymm6, 1344(%%r11)\n\t"\
"vmovapd 1376(%%r11), %%ymm7\n\t"\
"vaddpd %%ymm8, %%ymm8, %%ymm8\n\t"\
"vmulpd %%ymm9, %%ymm9, %%ymm9\n\t"\
"vaddpd %%ymm10, %%ymm10, %%ymm10\n\t"\
"vmulpd %%ymm11, %%ymm11, %%ymm11\n\t"\
"vmovapd 1408(%%r11), %%ymm12\n\t"\
"vmovapd %%ymm13, 1440(%%r11)\n\t"\
"vmovapd 1472(%%r11), %%ymm14\n\t"\
"vmovapd 1504(%%r11), %%ymm15\n\t"\
"vmovapd %%ymm0, 1536(%%r11)\n\t"\
"vmovapd 1568(%%r11), %%ymm1\n\t"\
"vmovapd 1600(%%r11), %%ymm2\n\t"\
"vmovapd %%ymm3, 1632(%%r11)\n\t"\
"vmovapd 1664(%%r11), %%ymm4\n\t"\
"vmovapd 1696(%%r11), %%ymm5\n\t"\
"vmovapd %%ymm6, 1728(%%r11)\n\t"\
"vaddpd %%ymm7, %%ymm7, %%ymm7\n\t"\
"vmulpd %%ymm8, %%ymm8, %%ymm8\n\t"\
"vaddpd %%ymm9, %%ymm9, %%ymm9\n\t"\
"vmulpd %%ymm10, %%ymm10, %%ymm10\n\t"\
"vmovapd 1760(%%r11), %%ymm11\n\t"\
"vmovapd 1792(%%r11), %%ymm12\n\t"\
"vmovapd %%ymm13, 1824(%%r11)\n\t"\
"vmovapd 1856(%%r11), %%ymm14\n\t"\
"vmovapd 1888(%%r11), %%ymm15\n\t"\
"vmovapd %%ymm0, 1920(%%r11)\n\t"\
"vmovapd 1952(%%r11), %%ymm1\n\t"\
"vmovapd 1984(%%r11), %%ymm2\n\t"\
...
roofline_output_end_measure(out, repeat*data->size, repeat*data->size*96/2112, repeat*data->size*90/2112);
