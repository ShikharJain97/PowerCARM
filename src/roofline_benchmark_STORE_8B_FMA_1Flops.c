...
"vmovapd %%ymm9, 192(%%r11)\n\t"\
"vmovapd %%ymm10, 224(%%r11)\n\t"\
"vfmadd132pd %%ymm11, %%ymm11, %%ymm11\n\t"\
"vmovapd %%ymm12, 256(%%r11)\n\t"\
"vmovapd %%ymm13, 288(%%r11)\n\t"\
"vfmadd132pd %%ymm14, %%ymm14, %%ymm14\n\t"\
"vmovapd %%ymm15, 320(%%r11)\n\t"\
"vmovapd %%ymm0, 352(%%r11)\n\t"\
"vfmadd132pd %%ymm1, %%ymm1, %%ymm1\n\t"\
"vmovapd %%ymm2, 384(%%r11)\n\t"\
"vmovapd %%ymm3, 416(%%r11)\n\t"\
"vfmadd132pd %%ymm4, %%ymm4, %%ymm4\n\t"\
"vmovapd %%ymm5, 448(%%r11)\n\t"\
"vmovapd %%ymm6, 480(%%r11)\n\t"\
"vfmadd132pd %%ymm7, %%ymm7, %%ymm7\n\t"\
"vmovapd %%ymm8, 512(%%r11)\n\t"\
"vmovapd %%ymm9, 544(%%r11)\n\t"\
"vfmadd132pd %%ymm10, %%ymm10, %%ymm10\n\t"\
"vmovapd %%ymm11, 576(%%r11)\n\t"\
"vmovapd %%ymm12, 608(%%r11)\n\t"\
"vfmadd132pd %%ymm13, %%ymm13, %%ymm13\n\t"\
"vmovapd %%ymm14, 640(%%r11)\n\t"\
"vmovapd %%ymm15, 672(%%r11)\n\t"\
"vfmadd132pd %%ymm0, %%ymm0, %%ymm0\n\t"\
"vmovapd %%ymm1, 704(%%r11)\n\t"\
"vmovapd %%ymm2, 736(%%r11)\n\t"\
"vfmadd132pd %%ymm3, %%ymm3, %%ymm3\n\t"\
"vmovapd %%ymm4, 768(%%r11)\n\t"\
"vmovapd %%ymm5, 800(%%r11)\n\t"\
"vfmadd132pd %%ymm6, %%ymm6, %%ymm6\n\t"\
"vmovapd %%ymm7, 832(%%r11)\n\t"\
"vmovapd %%ymm8, 864(%%r11)\n\t"\
"vfmadd132pd %%ymm9, %%ymm9, %%ymm9\n\t"\
"vmovapd %%ymm10, 896(%%r11)\n\t"\
"vmovapd %%ymm11, 928(%%r11)\n\t"\
"vfmadd132pd %%ymm12, %%ymm12, %%ymm12\n\t"\
"vmovapd %%ymm13, 960(%%r11)\n\t"\
"vmovapd %%ymm14, 992(%%r11)\n\t"\
"vfmadd132pd %%ymm15, %%ymm15, %%ymm15\n\t"\
"vmovapd %%ymm0, 1024(%%r11)\n\t"\
"vmovapd %%ymm1, 1056(%%r11)\n\t"\
"vfmadd132pd %%ymm2, %%ymm2, %%ymm2\n\t"\
"vmovapd %%ymm3, 1088(%%r11)\n\t"\
"vmovapd %%ymm4, 1120(%%r11)\n\t"\
"vfmadd132pd %%ymm5, %%ymm5, %%ymm5\n\t"\
"vmovapd %%ymm6, 1152(%%r11)\n\t"\
"vmovapd %%ymm7, 1184(%%r11)\n\t"\
"vfmadd132pd %%ymm8, %%ymm8, %%ymm8\n\t"\
"vmovapd %%ymm9, 1216(%%r11)\n\t"\
"vmovapd %%ymm10, 1248(%%r11)\n\t"\
"vfmadd132pd %%ymm11, %%ymm11, %%ymm11\n\t"\
"vmovapd %%ymm12, 1280(%%r11)\n\t"\
"vmovapd %%ymm13, 1312(%%r11)\n\t"\
"vfmadd132pd %%ymm14, %%ymm14, %%ymm14\n\t"\
"vmovapd %%ymm15, 1344(%%r11)\n\t"\
"vmovapd %%ymm0, 1376(%%r11)\n\t"\
"vfmadd132pd %%ymm1, %%ymm1, %%ymm1\n\t"\
"vmovapd %%ymm2, 1408(%%r11)\n\t"\
"vmovapd %%ymm3, 1440(%%r11)\n\t"\
"vfmadd132pd %%ymm4, %%ymm4, %%ymm4\n\t"\
"vmovapd %%ymm5, 1472(%%r11)\n\t"\
"vmovapd %%ymm6, 1504(%%r11)\n\t"\
"vfmadd132pd %%ymm7, %%ymm7, %%ymm7\n\t"\
"add $1536, %%r11\n\t"\
"sub $1536, %%r12\n\t"\
