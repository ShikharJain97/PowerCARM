...
"vmovntpd %%ymm5, 96(%%r11)\n\t"\
"vmovntpd %%ymm6, 128(%%r11)\n\t"\
"vmovntpd %%ymm7, 160(%%r11)\n\t"\
"vaddpd %%ymm8, %%ymm8, %%ymm8\n\t"\
"vmulpd %%ymm9, %%ymm9, %%ymm9\n\t"\
"vmovntpd %%ymm10, 192(%%r11)\n\t"\
"vmovntpd %%ymm11, 224(%%r11)\n\t"\
"vmovntpd %%ymm12, 256(%%r11)\n\t"\
"vaddpd %%ymm13, %%ymm13, %%ymm13\n\t"\
"vmulpd %%ymm14, %%ymm14, %%ymm14\n\t"\
"vmovntpd %%ymm15, 288(%%r11)\n\t"\
"vmovntpd %%ymm0, 320(%%r11)\n\t"\
"vmovntpd %%ymm1, 352(%%r11)\n\t"\
"vaddpd %%ymm2, %%ymm2, %%ymm2\n\t"\
"vmulpd %%ymm3, %%ymm3, %%ymm3\n\t"\
"vmovntpd %%ymm4, 384(%%r11)\n\t"\
"vmovntpd %%ymm5, 416(%%r11)\n\t"\
"vmovntpd %%ymm6, 448(%%r11)\n\t"\
"vaddpd %%ymm7, %%ymm7, %%ymm7\n\t"\
"vmulpd %%ymm8, %%ymm8, %%ymm8\n\t"\
"vmovntpd %%ymm9, 480(%%r11)\n\t"\
"vmovntpd %%ymm10, 512(%%r11)\n\t"\
"vmovntpd %%ymm11, 544(%%r11)\n\t"\
"vaddpd %%ymm12, %%ymm12, %%ymm12\n\t"\
"vmulpd %%ymm13, %%ymm13, %%ymm13\n\t"\
"vmovntpd %%ymm14, 576(%%r11)\n\t"\
"vmovntpd %%ymm15, 608(%%r11)\n\t"\
"vmovntpd %%ymm0, 640(%%r11)\n\t"\
"vaddpd %%ymm1, %%ymm1, %%ymm1\n\t"\
"vmulpd %%ymm2, %%ymm2, %%ymm2\n\t"\
"vmovntpd %%ymm3, 672(%%r11)\n\t"\
"vmovntpd %%ymm4, 704(%%r11)\n\t"\
"vmovntpd %%ymm5, 736(%%r11)\n\t"\
"vaddpd %%ymm6, %%ymm6, %%ymm6\n\t"\
"vmulpd %%ymm7, %%ymm7, %%ymm7\n\t"\
"vmovntpd %%ymm8, 768(%%r11)\n\t"\
"vmovntpd %%ymm9, 800(%%r11)\n\t"\
"vmovntpd %%ymm10, 832(%%r11)\n\t"\
...
"vmovntpd %%ymm1, 1248(%%r11)\n\t"\
"vmovntpd %%ymm2, 1280(%%r11)\n\t"\
"vmovntpd %%ymm3, 1312(%%r11)\n\t"\
"vaddpd %%ymm4, %%ymm4, %%ymm4\n\t"\
"vmulpd %%ymm5, %%ymm5, %%ymm5\n\t"\
"vmovntpd %%ymm6, 1344(%%r11)\n\t"\
"vmovntpd %%ymm7, 1376(%%r11)\n\t"\
"vmovntpd %%ymm8, 1408(%%r11)\n\t"\
