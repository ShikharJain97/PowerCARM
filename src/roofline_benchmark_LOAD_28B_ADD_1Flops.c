...
"vmovapd 1152(%%r11), %%ymm14\n\t"\
"vmovapd 1184(%%r11), %%ymm15\n\t"\
"vmovapd 1216(%%r11), %%ymm0\n\t"\
"vmovapd 1248(%%r11), %%ymm1\n\t"\
...
"vmovapd 1632(%%r11), %%ymm1\n\t"\
"vmovapd 1664(%%r11), %%ymm2\n\t"\
"vmovapd 1696(%%r11), %%ymm3\n\t"\
"vmovapd 1728(%%r11), %%ymm4\n\t"\
...
roofline_output_end_measure(out, repeat*data->size, repeat*data->size*64/1792, repeat*data->size*72/1792);
