...
"vmovapd 128(%%r11), %%ymm6\n\t"\
"vmovapd 160(%%r11), %%ymm7\n\t"\
"vaddpd %%ymm8, %%ymm8, %%ymm8\n\t"\
"vmovapd 192(%%r11), %%ymm9\n\t"\
"vmovapd 224(%%r11), %%ymm10\n\t"\
"vmulpd %%ymm11, %%ymm11, %%ymm11\n\t"\
"vmovapd 256(%%r11), %%ymm12\n\t"\
"vmovapd 288(%%r11), %%ymm13\n\t"\
"vaddpd %%ymm14, %%ymm14, %%ymm14\n\t"\
"vmovapd 320(%%r11), %%ymm15\n\t"\
"vmovapd 352(%%r11), %%ymm0\n\t"\
"vmulpd %%ymm1, %%ymm1, %%ymm1\n\t"\
"vmovapd 384(%%r11), %%ymm2\n\t"\
"vmovapd 416(%%r11), %%ymm3\n\t"\
"vaddpd %%ymm4, %%ymm4, %%ymm4\n\t"\
"vmovapd 448(%%r11), %%ymm5\n\t"\
"vmovapd 480(%%r11), %%ymm6\n\t"\
"vmulpd %%ymm7, %%ymm7, %%ymm7\n\t"\
"vmovapd 512(%%r11), %%ymm8\n\t"\
"vmovapd 544(%%r11), %%ymm9\n\t"\
"vaddpd %%ymm10, %%ymm10, %%ymm10\n\t"\
"vmovapd 576(%%r11), %%ymm11\n\t"\
"vmovapd 608(%%r11), %%ymm12\n\t"\
"vmulpd %%ymm13, %%ymm13, %%ymm13\n\t"\
"vmovapd 640(%%r11), %%ymm14\n\t"\
"vmovapd 672(%%r11), %%ymm15\n\t"\
"vaddpd %%ymm0, %%ymm0, %%ymm0\n\t"\
"vmovapd 704(%%r11), %%ymm1\n\t"\
"vmovapd 736(%%r11), %%ymm2\n\t"\
"vmulpd %%ymm3, %%ymm3, %%ymm3\n\t"\
"vmovapd 768(%%r11), %%ymm4\n\t"\
"vmovapd 800(%%r11), %%ymm5\n\t"\
"vaddpd %%ymm6, %%ymm6, %%ymm6\n\t"\
"vmovapd 832(%%r11), %%ymm7\n\t"\
"vmovapd 864(%%r11), %%ymm8\n\t"\
"vmulpd %%ymm9, %%ymm9, %%ymm9\n\t"\
"vmovapd 896(%%r11), %%ymm10\n\t"\
"vmovapd 928(%%r11), %%ymm11\n\t"\
"vaddpd %%ymm12, %%ymm12, %%ymm12\n\t"\
"vmovapd 960(%%r11), %%ymm13\n\t"\
"vmovapd 992(%%r11), %%ymm14\n\t"\
"vmulpd %%ymm15, %%ymm15, %%ymm15\n\t"\
"vmovapd 1024(%%r11), %%ymm0\n\t"\
"vmovapd 1056(%%r11), %%ymm1\n\t"\
"vaddpd %%ymm2, %%ymm2, %%ymm2\n\t"\
"vmovapd 1088(%%r11), %%ymm3\n\t"\
"vmovapd 1120(%%r11), %%ymm4\n\t"\
"vmulpd %%ymm5, %%ymm5, %%ymm5\n\t"\
"vmovapd 1152(%%r11), %%ymm6\n\t"\
"vmovapd 1184(%%r11), %%ymm7\n\t"\
"vaddpd %%ymm8, %%ymm8, %%ymm8\n\t"\
"vmovapd 1216(%%r11), %%ymm9\n\t"\
"vmovapd 1248(%%r11), %%ymm10\n\t"\
"vmulpd %%ymm11, %%ymm11, %%ymm11\n\t"\
...
"vaddpd %%ymm4, %%ymm4, %%ymm4\n\t"\
"vmovapd 1472(%%r11), %%ymm5\n\t"\
"vmovapd 1504(%%r11), %%ymm6\n\t"\
"vmulpd %%ymm7, %%ymm7, %%ymm7\n\t"\
"add $1536, %%r11\n\t"\
"sub $1536, %%r12\n\t"\
...
roofline_output_end_measure(out, repeat*data->size, repeat*data->size*96/1536, repeat*data->size*72/1536);
