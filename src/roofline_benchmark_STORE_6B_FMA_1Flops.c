...
"vmovapd %%ymm5, 96(%%r11)\n\t"\
"vmovapd %%ymm6, 128(%%r11)\n\t"\
"vmovapd %%ymm7, 160(%%r11)\n\t"\
"vfmadd132pd %%ymm8, %%ymm8, %%ymm8\n\t"\
"vfmadd132pd %%ymm9, %%ymm9, %%ymm9\n\t"\
"vmovapd %%ymm10, 192(%%r11)\n\t"\
"vmovapd %%ymm11, 224(%%r11)\n\t"\
"vmovapd %%ymm12, 256(%%r11)\n\t"\
"vfmadd132pd %%ymm13, %%ymm13, %%ymm13\n\t"\
"vfmadd132pd %%ymm14, %%ymm14, %%ymm14\n\t"\
"vmovapd %%ymm15, 288(%%r11)\n\t"\
"vmovapd %%ymm0, 320(%%r11)\n\t"\
"vmovapd %%ymm1, 352(%%r11)\n\t"\
"vfmadd132pd %%ymm2, %%ymm2, %%ymm2\n\t"\
"vfmadd132pd %%ymm3, %%ymm3, %%ymm3\n\t"\
"vmovapd %%ymm4, 384(%%r11)\n\t"\
"vmovapd %%ymm5, 416(%%r11)\n\t"\
"vmovapd %%ymm6, 448(%%r11)\n\t"\
"vfmadd132pd %%ymm7, %%ymm7, %%ymm7\n\t"\
"vfmadd132pd %%ymm8, %%ymm8, %%ymm8\n\t"\
"vmovapd %%ymm9, 480(%%r11)\n\t"\
"vmovapd %%ymm10, 512(%%r11)\n\t"\
"vmovapd %%ymm11, 544(%%r11)\n\t"\
"vfmadd132pd %%ymm12, %%ymm12, %%ymm12\n\t"\
"vfmadd132pd %%ymm13, %%ymm13, %%ymm13\n\t"\
"vmovapd %%ymm14, 576(%%r11)\n\t"\
"vmovapd %%ymm15, 608(%%r11)\n\t"\
"vmovapd %%ymm0, 640(%%r11)\n\t"\
"vfmadd132pd %%ymm1, %%ymm1, %%ymm1\n\t"\
"vfmadd132pd %%ymm2, %%ymm2, %%ymm2\n\t"\
"vmovapd %%ymm3, 672(%%r11)\n\t"\
"vmovapd %%ymm4, 704(%%r11)\n\t"\
"vmovapd %%ymm5, 736(%%r11)\n\t"\
"vfmadd132pd %%ymm6, %%ymm6, %%ymm6\n\t"\
"vfmadd132pd %%ymm7, %%ymm7, %%ymm7\n\t"\
"vmovapd %%ymm8, 768(%%r11)\n\t"\
"vmovapd %%ymm9, 800(%%r11)\n\t"\
"vmovapd %%ymm10, 832(%%r11)\n\t"\
"vfmadd132pd %%ymm11, %%ymm11, %%ymm11\n\t"\
"vfmadd132pd %%ymm12, %%ymm12, %%ymm12\n\t"\
"vmovapd %%ymm13, 864(%%r11)\n\t"\
"vmovapd %%ymm14, 896(%%r11)\n\t"\
"vmovapd %%ymm15, 928(%%r11)\n\t"\
"vfmadd132pd %%ymm0, %%ymm0, %%ymm0\n\t"\
"vfmadd132pd %%ymm1, %%ymm1, %%ymm1\n\t"\
"vmovapd %%ymm2, 960(%%r11)\n\t"\
"vmovapd %%ymm3, 992(%%r11)\n\t"\
"vmovapd %%ymm4, 1024(%%r11)\n\t"\
"vfmadd132pd %%ymm5, %%ymm5, %%ymm5\n\t"\
"vfmadd132pd %%ymm6, %%ymm6, %%ymm6\n\t"\
"vmovapd %%ymm7, 1056(%%r11)\n\t"\
"vmovapd %%ymm8, 1088(%%r11)\n\t"\
"vmovapd %%ymm9, 1120(%%r11)\n\t"\
"vfmadd132pd %%ymm10, %%ymm10, %%ymm10\n\t"\
"vfmadd132pd %%ymm11, %%ymm11, %%ymm11\n\t"\
"vmovapd %%ymm12, 1152(%%r11)\n\t"\
"vmovapd %%ymm13, 1184(%%r11)\n\t"\
"vmovapd %%ymm14, 1216(%%r11)\n\t"\
...
"vmovapd %%ymm7, 1376(%%r11)\n\t"\
"vmovapd %%ymm8, 1408(%%r11)\n\t"\
"vfmadd132pd %%ymm9, %%ymm9, %%ymm9\n\t"\
"vfmadd132pd %%ymm10, %%ymm10, %%ymm10\n\t"\
"add $1440, %%r11\n\t"\
"sub $1440, %%r12\n\t"\
...
roofline_output_end_measure(out, repeat*data->size, repeat*data->size*240/1440, repeat*data->size*75/1440);
